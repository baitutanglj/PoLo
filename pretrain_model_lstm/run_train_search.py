...
from data_loader_search import MyDataset, mycollate_fn, mycollate_fn_test
from pretrain_model_search import lstm_model
...
def add_args():
    ...
    parser.add_argument("--epochs", type=int, help="model train epochs", default=100)
...
class Trainer(object):
    def __init__(self, args):
        ...
        self.test_loader = DataLoader(self.test_data, batch_size=args.batch_size, shuffle=False, collate_fn=mycollate_fn_test)
    ...
    def train_epoch(self):
        ...
        epoch_acc = acc / len(pre_action_list)
    ...
    def test(self):
        ...
        with torch.no_grad():
            for x_batch, y_batch in self.test_loader:
                ...
                score, entity_trajectory, relation_trajectory = self.model.sample_forward(x_batch, self.train_data.grapher)  # torch.Size([4096, 501])
            test_loss = total_loss / len(self.test_loader)
            test_acc = acc / (len(self.test_data)*4)
